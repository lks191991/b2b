	...
	public function zoneReport(Request $request)
{
	...
	->select(
		...
		DB::raw('SUM(CASE WHEN va.actual_total_cost > 0 THEN va.original_tkt_rate ELSE 0 END) AS totalAccountedSell'),
		DB::raw('SUM(CASE WHEN va.actual_total_cost > 0 THEN va.discount_tkt ELSE 0 END) AS totalAccountedSellDis'),
		DB::raw('SUM(CASE WHEN va.actual_total_cost = 0 THEN va.original_tkt_rate ELSE 0 END) AS totalUnAccountedSell'),
		DB::raw('SUM(CASE WHEN va.actual_total_cost = 0 THEN va.discount_tkt ELSE 0 END) AS totalUnAccountedSellDis'),
		DB::raw('SUM(CASE WHEN va.actual_total_cost IS NOT NULL THEN va.original_tkt_rate ELSE 0 END) AS totalSells'),
		DB::raw('SUM(CASE WHEN va.actual_total_cost IS NOT NULL THEN va.discount_tkt ELSE 0 END) AS totalSellsDis'),
		DB::raw('SUM(CASE WHEN va.actual_total_cost IS NOT NULL THEN va.actual_total_cost ELSE 0 END) AS totalCost'),
		DB::raw('SUM(CASE WHEN (va.actual_transfer_cost + va.actual_transfer_cost2) > 0 AND va.original_trans_rate IS NOT NULL THEN va.original_trans_rate ELSE 0 END) AS totalAccountedTransSell'),
		DB::raw('SUM(CASE WHEN (va.actual_transfer_cost + va.actual_transfer_cost2) = 0 AND va.original_trans_rate IS NOT NULL THEN va.original_trans_rate ELSE 0 END) AS totalUnAccountedTransSell'),
		DB::raw('SUM(CASE WHEN (va.actual_transfer_cost + va.actual_transfer_cost2) IS NOT NULL THEN va.original_trans_rate ELSE 0 END) AS totalTransSells'),

		DB::raw('SUM(CASE WHEN (va.actual_transfer_cost + va.actual_transfer_cost2) > 0 AND va.discount_sic_pvt_price IS NOT NULL THEN va.discount_sic_pvt_price ELSE 0 END) AS totalAccountedTransSellDis'),
		DB::raw('SUM(CASE WHEN (va.actual_transfer_cost + va.actual_transfer_cost2) = 0 AND va.discount_sic_pvt_price IS NOT NULL THEN va.discount_sic_pvt_price ELSE 0 END) AS totalUnAccountedTransSellDis'),
		DB::raw('SUM(CASE WHEN (va.actual_transfer_cost + va.actual_transfer_cost2) IS NOT NULL THEN va.discount_sic_pvt_price ELSE 0 END) AS totalTransSellsDis'),
		DB::raw('SUM(CASE WHEN va.actual_transfer_cost IS NOT NULL THEN va.actual_transfer_cost ELSE 0 END) AS totalTransCost')
	)
