...
@endphp
		...
		<div class="col-12 col-sm-6 col-md-3">
			...
			<span class="info-box-icon bg-success elevation-1"><i class="fas fa-shopping-cart"></i></span>
			@php
    $totalSellsYearRaw = $vouchersYear ? ($vouchersYear->totalSells - $vouchersYear->totalSellsDis) : 0;
    $totalTransSellsYearRaw = $vouchersYear ? ($vouchersYear->totalTransSells - $vouchersYear->totalTransSellsDis) : 0;
    $yearTotalSellRaw = $totalSellsYearRaw + $totalTransSellsYearRaw;
    $gtotalSellYear = number_format($yearTotalSellRaw, 2);
@endphp
