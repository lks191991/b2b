    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <td>{{ ($record->invoice_number)}}</td>
					...
					<td>{{  SiteHelpers::getVoucherTotalPriceNew($record->id);}}</td>
					 ...
					 <a class="btn btn-info btn-sm" href="{{route('quotation.add.hotels',$record->id)}}">
                              <i class="fas fa-plus">
        ...
        <a class="btn btn-success btn-sm" href="#">
					 ...
					 @if($record->is_activity == 1)
						 @if($record->status_main < 4)
					 <a class="btn btn-info btn-sm" href="{{route('quotation.add.activity',$record->id)}}">
                              <i class="fas fa-plus">
           ...
           <i class="fas fa-file">
                     ...
                     <td>
					  ...
					  <a class="btn btn-info btn-sm" title="Checkout" href="{{route('quotations.show',$record->id)}}">
					 ...
					 <a class="btn btn-info btn-sm" href="{{route('quotationView',$record->id)}}">
                          ...
                          @endif
						  @if($record->status_main < 5)
					 <a class="btn btn-info btn-sm" href="{{route('quotations.edit',$record->id)}}">
