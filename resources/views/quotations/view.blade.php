              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row" style="margin-bottom: 15px;">
                    ...
                    <div class="col-4">
                     <input type="text" name="customer_mobile" value="" required='required'z class="form-control" placeholder="Mobile No.">
                    </div>
				  ...
				  <div class="row" style="margin-bottom: 15px;">
				  <div class="col-6">
                      <input type="text" required name="file_handling_by" value="{{$voucher->file_handling_by}}" class="form-control" placeholder="File Handling By*">
                    </div>
				  <div class="col-6">
